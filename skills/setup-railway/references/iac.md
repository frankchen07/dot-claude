...
`railway config init` and `railway config pull` also create `.railway/README.md`. Railway agent setup installs the shared `setup-railway` skill; config commands do not need or create a project-local skill.
